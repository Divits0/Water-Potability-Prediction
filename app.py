...
def main():
    ...
    st.write('Enter 9 numerical inputs below:')
    ...
    if st.button('Predict'):
        ...
        if output == 0.0:
            ...
            st.write(f'Predicted Output: The water with above parameters is not potable')
        else:
            st.write(f'Predicted Output: The water with above parameters is potable')
